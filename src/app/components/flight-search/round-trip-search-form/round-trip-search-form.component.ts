...
@Component({
  selector: 'app-round-trip-search-form',
  templateUrl: './round-trip-search-form.component.html',
  styleUrls: ['./round-trip-search-form.component.css']
})
export class RoundTripSearchFormComponent implements OnInit {
  noAdult: string = '';
  noChild: string = '';
  noInfant: string = '';
  passengerTypes: any;
  ...
  searchFlight() {
    this.flightSearchService.segmentSearch(
      this.flightSearchForm.value.origin, 
      this.flightSearchForm.value.destination, 
      this.flightSearchForm.value.departureDate, 
      this.flightSearchForm.value.passengers.adult,
      this.flightSearchForm.value.passengers.child,
      this.flightSearchForm.value.passengers.infant)
        .then(response => {
          this.flights = response.data;
          this.router.navigate(['/round-trip']);
